      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-700 leading-relaxed">
            Ready to transform your investment strategy with AI-powered insights? 
            Get in touch with our team to learn more about TradeOn.AI's enterprise solutions.
          </p>
        </div>
      </section>
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">contact@tradeon.ai</p>
                      <p className="text-slate-600">enterprise@tradeon.ai</p>
                    </div>
                  </div>
              ...
              <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-slate-700 mb-4">
                    Looking for custom API integrations, dedicated support, or enterprise-grade solutions? 
                    Our team can help you build the perfect solution for your business needs.
                  </p>
                  <Button 
                    variant="outline" 
